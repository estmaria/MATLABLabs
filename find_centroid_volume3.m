...
for i=1:N
    V_predicted=V_predicted+1/2*((A-1/2*i*deltaZ)*(B-i*deltaZ)*deltaZ);
end
...
for i=1:N
    numerator=numerator+(i*deltaZ)*1/2*((A-1/2*i*deltaZ)*(B-i*deltaZ)*deltaZ); %V_predicted*(i*deltaZ)
    denominator=denominator+1/2*((A-1/2*i*deltaZ)*(B-i*deltaZ)*deltaZ); %same as V_predicted
end
