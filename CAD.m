% This script computes mode shapes and corresponding natural
...
clc;
close all;
disp('What is the X-section of the beam to be computed ?')
...
elseif CS==1
    ...
    Ro=input('Enter material density in [kg/m^3]:  ');
        ...
        disp('Steel: E=2.1e+11 [Pa]; Ro=7850 [Kg/m^3]')
        disp('Copper: E=1.2e+11 [Pa]; Ro=8933 [Kg/m^3]')
        disp('Aluminum: E=0.69e+11 [Pa]; Ro=2700 [Kg/m^3]')
        E=input('Enter Young"s modulus in [Pa]: ');
        Ro=input('Enter material density in [kg/m^3]:  ');
    end
elseif CS==2
